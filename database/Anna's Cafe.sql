CREATE DATABASE  IF NOT EXISTS `Anna's Cafe` /*!40100 DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci */ /*!80016 DEFAULT ENCRYPTION='N' */;
USE `Anna's Cafe`;
...
INSERT INTO `food_items` VALUES (1,'Margherita',119.00),(2,'Cheesy',129.00),(3,'Farm House',149.00),(4,'Peppy Paneer',149.00),(5,'Mexican Green Wave',179.00),(6,'Deluxe Veggie',199.00),(7,'Cheese n Corn',119.00),(8,'Fresh Veggie',199.00),(9,'Veggie Paradise',229.00),(10,'Paneer Makhani',209.00),(11,'Indi Tandoori Paneer',249.00),(12,'The 4 Cheese Pizza',249.00);
...
INSERT INTO `orders` VALUES (40,1,2,238.00),(40,3,1,149.00),(41,4,3,447.00),(41,6,2,398.00),(41,9,4,916.00);
